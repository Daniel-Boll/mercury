...
Cross-reference candidate's profile + resume against requirements:

| Category | Meaning |
|---|---|
| ✅ Strong match | Direct experience with this skill/domain, demonstrated in resume |
| 🟡 Transferable | Adjacent experience that can be framed toward this requirement |
| ❌ Gap | Genuine miss — not present in resume or profile |
...
2. **Rephrase descriptions** — echo job description language for ATS matching
3. **Adjust summary/objective** — target the specific role and company
4. **Surface relevant projects** — pull from LinkedIn projects/OSS that match
5. **Keyword injection** — ensure critical ATS terms appear naturally
6. **Preserve format** — maintain the user's Typst structure, tone, and style
...
5. Cover letters must only claim experience backed by resume/profile data
...
2. Fetches LinkedIn profile
3. Fetches all 3 job details in parallel
4. Produces 3 tailored resumes, 3 cover letters, 3 gap reports
5. Logs the run
